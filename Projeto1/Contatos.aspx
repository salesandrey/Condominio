<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contatos.aspx.cs" Inherits="Projeto1.Contatos" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="llA" runat="server" ForeColor="White" Text="contato@ajcondominios.com.br"></asp:Label>
        <asp:Label ID="llB" runat="server" ForeColor="White" Text="facebook.com/AJCondominios"></asp:Label>
        <asp:Label ID="llC" runat="server" ForeColor="White" Text="twitter.com/AJCondominios"></asp:Label>
        <asp:Label ID="llD" runat="server" ForeColor="White" Text="(41)9999-9999"></asp:Label>
        <asp:Label ID="llE" runat="server" ForeColor="White" Text="(41)3232-3232"></asp:Label>
        <asp:Label ID="llF" runat="server" Font-Names="Cambria Math" ForeColor="White" Text="R.Lorem Ipsum, s/n,Prado Velho,Curitiba-Paraná"></asp:Label>
        <asp:Label ID="lbtt" runat="server" Text="Deseja nos Contactar ?" ForeColor="White"></asp:Label>
        ...
        <link href="csss/Contato.css" rel="stylesheet" />
        <div id="fundo"></div>
