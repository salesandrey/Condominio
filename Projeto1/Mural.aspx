<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mural.aspx.cs" Inherits="Projeto1.M" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="WHATS"></div>
            ...
            <asp:Button ID="BtPainel" runat="server" Text="Painel de Avisos" Width="120px" Height="35px" OnClick="BtPainel_Click" BackColor="White" Enabled="False" />
